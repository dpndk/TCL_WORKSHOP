...
if {![regexp {^csv} $input] || $argc != 1 } {
    ...
    puts "Input file is valid: $input"
    puts "Proceeding with processing..."

#..........................................................................................................................................................................##.............Converts .csv to matix and creates initial variables "DesignName OutputDirectory NetlistDirectory EarlyLibraryPath LateLibraryPath"..........................##..........................................................................................................................................................................#

set filename [lindex $argv 0]
puts "Input CSV filename: $filename"

# Load necessary packages
package require csv
puts "csv package loaded"

package require struct::matrix
puts "struct::matrix package loaded"

# Create a matrix named 'm'
struct::matrix m
puts "Matrix 'm' created"
...
puts "CSV content successfully read into matrix 'm'"
...
puts "Number of columns in matrix: $columns"

# Link the matrix to a Tcl array called 'my_arr'
m link my_arr
puts "Matrix linked to array 'my_arr'"

# Get number of rows in the matrix
set number_of_rows [m rows]
puts "Number of rows in matrix: $number_of_rows"

set i 0
puts "Loop counter initialized: i = $i"
...
#..........................................................................................................................................................................#
#...............................Below script checks thr existence of  directories and files mentioned in csv file..........................................................#
#..........................................................................................................................................................................#
...
source /home/dipindask/vsdsynth/procs/reopenStdout.proc
source /home/dipindask/vsdsynth/procs/set_num_threads.proc
reopenStdout $OutputDirectory/$DesignName.conf
set_multi_cpu_usage -localCpu 4

#return

source /home/dipindask/vsdsynth/procs/read_lib.proc
read_lib -early /home/dipindask/vsdsynth/osu018_stdcells.lib

read_lib -late /home/dipindask/vsdsynth/osu018_stdcells.lib

#return 

source /home/dipindask/vsdsynth/procs/read_verilog.proc
read_verilog $OutputDirectory/$DesignName.final.synth.v


#return

source /home/dipindask/vsdsynth/procs/read_sdc.proc
...
set tcl_precision 3
set time_elapsed_in_us [time {exec /home/dipindask/OpenTimer/bin/OpenTimer < $OutputDirectory/$DesignName.conf >& $OutputDirectory/$DesignName.results} 1]
...
#---------------find WNS RAT(Worst Negative Slack of Required Arrival Time)-------------------------#
set worst_RAT_slack "-"
...
while {[gets $report_file line] != -1} {
	if {[regexp $pattern $line]} {
		puts "pattern \"$pattern\" found in line \"$line\""
		puts "old worst_RTA_slack is $worst_RTA_slack"
...
puts "Number_output_violations $Number_output_violations"
close $report_file


#---------------find WNS (Worst Negative slack) setup violation-------------------------#
...
#---------------find WNS (Worst Negative Slack) hold violation-------------------------#
...
#set Instance_count "$Instance_count dpn"
#set worst_negative_hold_slack "$worst_negative_hold_slack 010"
